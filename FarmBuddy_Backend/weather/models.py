...
from FarmBuddy_Backend.farmers.models import Farmer
...
class WeatherData(models.Model):
    ...
    def __str__(self):
        # Shows "Pune - Sunny - 28.5°C" when displaying
        return f"{self.location} - {self.condition} - {self.temperature}°C"
...
class WeatherForecast(models.Model):
    ...
    def __str__(self):
        # Shows "Pune - 2025-02-25 - Rainy (18-30°C)" when displaying
        return f"{self.location} - {self.forecast_date} - {self.condition} ({self.min_temperature}-{self.max_temperature}°C)"
