...
from FarmBuddy_Backend.farmers.models import Farmer, FarmerCrop  # Farmer and their crops
from FarmBuddy_Backend.crops.models import CropCareTask  # Pre-defined crop care tasks
