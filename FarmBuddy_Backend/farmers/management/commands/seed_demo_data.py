...
from FarmBuddy_Backend.crops.models import Crop, CropCareTask, CropGuide, CropRecommendation
from FarmBuddy_Backend.farmers.models import Farmer, FarmerCrop, FarmerInventory
from FarmBuddy_Backend.tasks.models import FarmerTask, TaskLog, TaskReminder
from FarmBuddy_Backend.weather.models import FarmersWeatherAlert, WeatherData, WeatherForecast
                ...
                "alerts": [
                    {
                        ...
                        "alert_message": "Day temperature above 34°C expected; increase mulch and morning irrigation.",
                        "severity": "High",
                        "alert_type": "Heat",
